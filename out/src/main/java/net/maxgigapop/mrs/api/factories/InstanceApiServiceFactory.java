...
import net.maxgigapop.mrs.api.impl.InstanceApiServiceImpl;
...
public class InstanceApiServiceFactory {
    private static final InstanceApiService service = new InstanceApiServiceImpl();

    public static InstanceApiService getInstanceApi() {
        return service;
    }
}
